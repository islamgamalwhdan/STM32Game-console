...
#define UMM_MALLOC_CFG_HEAP_SIZE  102400 //200kb

static __attribute__( ( section( ".sdram3" ) ) )
uint8_t  umm_malloc_CFG_Container[UMM_MALLOC_CFG_HEAP_SIZE] ;
static void *UMM_MALLOC_CFG_HEAP_ADDR = umm_malloc_CFG_Container ;//sdram3
/* ------------------------------------------------------------------------- */
